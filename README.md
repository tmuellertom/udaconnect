...
1. bring up new cluster with `k3d cluster create udaconnect -p "30000-300010:30000-300010@server[0]"  
This is needed, becaus on an M1 Vagrant with Virtualbox is not possible
2. install Kafka with README in modules/kafka
3. Deploy Folders to cluster kubectl apply -f /deployment/FOLDER`
  * connection
  * frontend-refactored
  * location-event
  * location-processor
  * person
4. install Databases:
  * do to /modules/connection and /modules/person
  * do `./script/run_db_command.sh PODNAME`
